       ...
       <div class="card-body">
           ...
           <div class="table-responsive text-nowrap">
               <div class="col-md-3 mb-2 mr-5" style=" margin-left: 10px;">
                   ...
                   <a href="{{ route('qr.create') }}"><button type="button" class="btn btn-primary">Create</button></a>
               </div>
               <table class="table contact-table" id="qrTable">
                   ...
                   @foreach($contacts as $contact)
                       <tr>
                           ...
                           <td><i class="fab fa-angular fa-lg text-danger me-3"></i> <strong>{{ $contact->designation }}</strong></td>
                           <td>
                           ...
                           <td>
                               <a href="{{route('qr.show',$contact->unique_id)}}" target="_blank" class="btn btn-primary">
                           ...
                           <td><img src="{{ asset($contact->qr) }}" width="50" height="50"></td>
                           <td>
                           ...
                           <td class="text-center">
                               <div class="dropdown">
                                   ...
                                   <div class="dropdown-menu">
                                       <a class="dropdown-item" href="{{ route('qr.edit',$contact->unique_id) }}"><i class="bx bx-edit-alt me-1"></i> Edit</a>
                                       <a class="dropdown-item" href="{{ route('qr.delete',$contact->unique_id) }}"><i class="bx bx-trash me-1"></i> Delete</a>
                                   </div>
                               </div>
                           </td>
                       </tr>
